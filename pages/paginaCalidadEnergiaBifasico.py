        ...
        try:
            ...
            if st.button("Generar Informe Automatizado", type="primary"):
                ...
                try:
                    ...
                    columnas_Tension_Unidades = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['U1(Min)', 'U1(Med)', 'U1(Max)', 'U2(Min)', 'U2(Med)', 'U2(Max)'], valores_Corchetes=['V'])
                    ...
                    columnas_Corriente_Unidades = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['I1(Min)', 'I1(Med)', 'I1(Max)', 'I2(Min)', 'I2(Med)', 'I2(Max)'], valores_Corchetes=['A'])
                    ...
                    columnas_Energia_Activa_Unidades = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['Eptot+(Med)', 'Eptot-(Med)', 'Ep1-(Med)', 'Ep2-(Med)', 'Ep1+(Med)', 'Ep2+(Med)'], valores_Corchetes=['kWh', 'Wh'])
                    ...
                    columnas_Energia_Inductiva_Unidades = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['EQtotind+(Med)', 'EQtotind-(Med)', 'EQfund1ind+(Med)', 'EQfund2ind+(Med)', 'EQfund1ind-(Med)', 'EQfund2ind-(Med)'], valores_Corchetes=['kvarh', 'varh'])
                    ...
                    columnas_Energia_Capacitiva_Unidades = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['EQtotcap+(Med)', 'EQtotcap-(Med)', 'EQfund1cap+(Med)', 'EQfund2cap+(Med)', 'EQfund1cap-(Med)', 'EQfund2cap-(Med)'], valores_Corchetes=['kvarh', 'varh'])
                    ...
                    list_Columns_Grafico_Tension: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['U1(Med)', 'U2(Med)'], valores_Corchetes=['V'])
                    ...
                    df_Tabla_Desbalance_Tension = filtrar_DataFrame_Columnas(dataFrame=df, nombres_Fijos_Columnas=['Hora', 'U1(Med)', 'U2(Med)'], valores_Corchetes=['UTC', 'V'])

                    df_Tabla_Desbalance_Corriente = filtrar_DataFrame_Columnas(dataFrame=df, nombres_Fijos_Columnas=['Hora', 'I1(Med)', 'I2(Med)'], valores_Corchetes=['UTC', 'A'])
                    ...
                    df_Tabla_Armonicos_Distorsion_Corriente = filtrar_DataFrame_Columnas(dataFrame=df, nombres_Fijos_Columnas=['Hora', 'I1 a3(Max)', 'I1 a5(Max)', 'I1 a7(Max)', 'I1 a9(Max)', 'I1 a11(Max)', 'I1 a13(Max)', 'I1 a15(Max)', 'I2 a3(Max)', 'I2 a5(Max)', 'I2 a7(Max)', 'I2 a9(Max)', 'I2 a11(Max)', 'I2 a13(Max)', 'I2 a15(Max)'], valores_Corchetes=['UTC', '%'])

                    df_Tabla_Armonicos_Cargabilidad_TDD = filtrar_DataFrame_Columnas(dataFrame=df, nombres_Fijos_Columnas=['Hora', 'TDD I1(ProAct)', 'TDD I2(ProAct)'], valores_Corchetes=['UTC', '%'])

                    df_Tabla_Flicker = filtrar_DataFrame_Columnas(dataFrame=df, nombres_Fijos_Columnas=['Hora', 'Plt1(Min)', 'Plt1(Med)', 'Plt1(Max)', 'Plt2(Min)', 'Plt2(Med)', 'Plt2(Max)'], valores_Corchetes=['UTC', ''])

                    df_Tabla_FactorK = filtrar_DataFrame_Columnas(dataFrame=df, nombres_Fijos_Columnas=['Hora', 'Ki1(Min)', 'Ki1(Med)', 'Ki1(Max)', 'Ki2(Min)', 'Ki2(Med)', 'Ki2(Max)'], valores_Corchetes=['UTC', ''])
                    ...
                    df_Tabla_Energias = filtrar_DataFrame_Columnas(dataFrame=df, nombres_Fijos_Columnas=['Hora', 'Ep1+(Med)', 'Ep2+(Med)', 'Ep1-(Med)', 'Ep2-(Med)', 'EQfund1cap+(Med)', 'EQfund2cap+(Med)', 'EQfund1cap-(Med)', 'EQfund2cap-(Med)', 'EQfund1ind+(Med)', 'EQfund2ind+(Med)', 'EQfund1ind-(Med)', 'EQfund2ind-(Med)'], valores_Corchetes=['UTC', 'Wh', 'varh'])
                    ...
                    df_Tabla_Desb_Corriente = crear_DataFrame_Desbalance_Corriente(dataFrame=df_Tabla_Desbalance_Corriente, val_Desb_Corr=var4, nombres_Fijos_Columnas=['I1(Med)', 'I2(Med)'], valores_Corchetes=['A'])
                    ...
                    df_Tabla_Calculos_Tension = crear_Medidas_DataFrame_Tension(dataFrame=df_Tabla_Tension_Final, listado_Columnas_a_Medir=obtener_Columnas_DataFrame(dataFrame=df_Tabla_Tension_Final, nombres_Fijos_Columnas=['U1(Min)', 'U1(Med)', 'U1(Max)', 'U2(Min)', 'U2(Med)', 'U2(Max)'], valores_Corchetes=['V']))
                    ...
                    df_Tabla_Calculos_Corriente = crear_Medidas_DataFrame_Corriente(dataFrame=df_Tabla_Corriente_Final, listado_Columnas_a_Medir=obtener_Columnas_DataFrame(dataFrame=df_Tabla_Corriente_Final, nombres_Fijos_Columnas=['I1(Min)', 'I1(Med)', 'I1(Max)', 'I2(Min)', 'I2(Med)', 'I2(Max)', 'IN(Min)', 'IN(Med)', 'IN(Max)'], valores_Corchetes=['A']))
                    ...
                    df_Tabla_Calculos_Desb_Corriente = crear_Medidas_DataFrame_DesbCorriente(dataFrame=df_Tabla_Desb_Corriente, listado_Columnas_a_Medir=obtener_Columnas_DataFrame(dataFrame=df_Tabla_Desb_Corriente, nombres_Fijos_Columnas=['I1(Med)', 'I2(Med)'], valores_Corchetes=['A']))
                    ...
                    df_Tabla_Calculos_DistCorriente = crear_Medidas_DataFrame_Distorsion_Corriente(dataFrame=df_Tabla_Distorsion_CorrienteFinal, listado_Columnas_a_Medir=obtener_Columnas_DataFrame(dataFrame=df_Tabla_Distorsion_CorrienteFinal, nombres_Fijos_Columnas=['THD I1(Max)', 'THD I2(Max)'], valores_Corchetes=['%']))
                    ...
                    df_Tabla_Calculos_Armonicos_DistCorriente = crear_Medidas_DataFrame_Armonicos_DistCorriente(dataFrame=df_Tabla_Armonicos_Distorsion_Corriente_Final, listado_Columnas_a_Medir=obtener_Columnas_DataFrame(dataFrame=df_Tabla_Armonicos_Distorsion_Corriente_Final, nombres_Fijos_Columnas=['I1 a3(Max)', 'I1 a5(Max)', 'I1 a7(Max)', 'I1 a9(Max)', 'I1 a11(Max)', 'I1 a13(Max)', 'I1 a15(Max)', 'I2 a3(Max)', 'I2 a5(Max)', 'I2 a7(Max)', 'I2 a9(Max)', 'I2 a11(Max)', 'I2 a13(Max)', 'I2 a15(Max)'], valores_Corchetes=['%']))
                    ...
                    df_Tabla_Calculos_CargabilidadTDD = crear_Medidas_DataFrame_CargabilidadTDD(dataFrame=df_Tabla_Armonicos_Cargabilidad_TDDFinal, listado_Columnas_a_Medir=obtener_Columnas_DataFrame(dataFrame=df_Tabla_Armonicos_Cargabilidad_TDDFinal, nombres_Fijos_Columnas=['TDD I1(ProAct)', 'TDD I2(ProAct)'], valores_Corchetes=['%']))
                    ...
                    df_Tabla_Calculos_Flicker = crear_Medidas_DataFrame_Flicker(dataFrame=df_Tabla_FlickerFinal, listado_Columnas_a_Medir=obtener_Columnas_DataFrame(dataFrame=df_Tabla_FlickerFinal, nombres_Fijos_Columnas=['Plt1(Med)', 'Plt2(Med)'], valores_Corchetes=['']))
                    ...
                    df_Tabla_Calculos_FactorK = crear_Medidas_DataFrame_FactorK(dataFrame=df_Tabla_FactorKFinal, listado_Columnas_a_Medir=obtener_Columnas_DataFrame(dataFrame=df_Tabla_FactorKFinal, nombres_Fijos_Columnas=['Ki1(Min)', 'Ki1(Med)', 'Ki1(Max)', 'Ki2(Min)', 'Ki2(Med)', 'Ki2(Max)'], valores_Corchetes=['']))
                    ...
                    listado_Columnas_PR_Tension: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['U1(Med)', 'U2(Med)'], valores_Corchetes=['V'])
                    ...
                    listado_Columnas_PR_Corriente: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['I1(Max)', 'I2(Max)', 'IN(Med)'], valores_Corchetes=['A'])
                    ...
                    data_Percentiles_Corriente: dict = {
                        ...
                        'PERCENTIL_CORR_MED_LN': round(df_Tabla_Calculos_Corriente[listado_Columnas_PR_Corriente[2]].iloc[0], 2)
                    }
                    ...
                    listado_Columnas_PR_Corriente_Maximos: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['I1(Max)', 'I2(Max)'], valores_Corchetes=['A'])
                    ...
                    listado_Columnas_PR_DistorsionCorriente: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['THD I1(Max)', 'THD I2(Max)'], valores_Corchetes=['%'])
                    ...
                    listado_Columnas_PR_CargabilidadTDD: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['TDD I1(ProAct)', 'TDD I2(ProAct)'], valores_Corchetes=['%'])
                    ...
                    listado_Columnas_PR_Flicker: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['Plt1(Med)', 'Plt2(Med)'], valores_Corchetes=[''])
                    ...
                    listado_Columnas_PR_FactorK: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['Ki1(Med)', 'Ki2(Med)'], valores_Corchetes=[''])
                    ...
                    listado_Variaciones_Tension_Minima_y_Maxima: list = obtener_Columnas_DataFrame(dataFrame=df_Tabla_Tension_Final, nombres_Fijos_Columnas=['U1(Min)', 'U2(Min)', 'U1(Max)', 'U2(Max)'], valores_Corchetes=['V'])
                    ...
                    listado_Columnas_Percentiles_Tension: list = obtener_Columnas_DataFrame(dataFrame=df_Tabla_Tension_Final, nombres_Fijos_Columnas=['U1(Min)', 'U2(Min)', 'U1(Med)', 'U2(Med)', 'U1(Max)', 'U2(Max)'], valores_Corchetes=['V'])

                    print(f'Listado de Columnas de Tensión para Percentiles: {listado_Columnas_Percentiles_Tension}')

                    listado_Percentiles_Tension: list = [round(df_Tabla_Calculos_Tension[listado_Columnas_Percentiles_Tension[0]].iloc[0], 2), round(df_Tabla_Calculos_Tension[listado_Columnas_Percentiles_Tension[2]].iloc[0], 2), round(df_Tabla_Calculos_Tension[listado_Columnas_Percentiles_Tension[1]].iloc[0], 2), round(df_Tabla_Calculos_Tension[listado_Columnas_Percentiles_Tension[3]].iloc[0], 2), round(df_Tabla_Calculos_Tension[listado_Columnas_Percentiles_Tension[5]].iloc[0], 2), round(df_Tabla_Calculos_Tension[listado_Columnas_Percentiles_Tension[4]].iloc[0], 2),]
                    ...
                    listado_Columnas_Percentiles_Corriente: list = obtener_Columnas_DataFrame(dataFrame=df_Tabla_Corriente_Final, nombres_Fijos_Columnas=['I1(Min)', 'I1(Med)', 'I1(Max)', 'I2(Min)', 'I2(Med)', 'I2(Max)', 'IN(Min)', 'IN(Med)', 'IN(Max)'], valores_Corchetes=['A'])
                    ...
                    diccionario_Percentiles_CorrienteNeutra: dict = {
                        'CORRIENTE_NEUTRA_MIN': round(df_Tabla_Calculos_Corriente[listado_Columnas_Percentiles_Corriente[6]].iloc[0], 2),
                        'CORRIENTE_NEUTRA_MED': round(df_Tabla_Calculos_Corriente[listado_Columnas_Percentiles_Corriente[8]].iloc[0], 2),
                        'CORRIENTE_NEUTRA_MAX': round(df_Tabla_Calculos_Corriente[listado_Columnas_Percentiles_Corriente[7]].iloc[0], 2)
                    }
                    ...
                    listado_Columnas_Percentiles_TDD: list = obtener_Columnas_DataFrame(dataFrame=df_Tabla_Armonicos_Cargabilidad_TDDFinal, nombres_Fijos_Columnas=['TDD I1(ProAct)', 'TDD I2(ProAct)'], valores_Corchetes=['%'])
                    ...
                    list_Columns_Distorsion_Corriente: list = obtener_Columnas_DataFrame(dataFrame=df_Tabla_Distorsion_CorrienteFinal, nombres_Fijos_Columnas=['THD I1(Max)', 'THD I2(Max)'], valores_Corchetes=['%'])
                    ...
                    list_Columns_Armonicos_Cargabilidad_TDD: list = obtener_Columnas_DataFrame(dataFrame=df_Tabla_Armonicos_Cargabilidad_TDDFinal, nombres_Fijos_Columnas=['TDD I1(ProAct)', 'TDD I2(ProAct)'], valores_Corchetes=['%'])
                    ...
                    list_Columns_Flicker: list = obtener_Columnas_DataFrame(dataFrame=df_Tabla_FlickerFinal, nombres_Fijos_Columnas=['Plt1(Med)', 'Plt2(Med)'], valores_Corchetes=[''])
                    ...
                    list_Columns_FactorK: list = obtener_Columnas_DataFrame(dataFrame=df_Tabla_FactorKFinal, nombres_Fijos_Columnas=['Ki1(Med)', 'Ki2(Med)'], valores_Corchetes=[''])
                    ...
                    listado_Registro_CargabilidadTDD: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['TDD I1(ProAct)', 'TDD I2(ProAct)'], valores_Corchetes=['%'])
                    print(f"Listado de Columnas del Registro de Cargabilidad TDD de Word: {listado_Registro_CargabilidadTDD}")
                    print("******"*50)

                    listado_Registro_Flicker: list = obtener_Columnas_DataFrame(dataFrame=df, nombres_Fijos_Columnas=['Plt1(Med)', 'Plt2(Med)'], valores_Corchetes=[''])
                            ...
                            if latitud and longitud:
                                try:
                                    ...
                                    registro = {
                                        ...
                                        'nombreCargo': str(nombreCargo).upper(),
                                        'nroConteoTarjeta': str(nroConteoTarjeta).upper(),
                                        'actividadRealizada': str(actividadRealizada).upper(),
                                        'nombreProyecto': str(nombreProyecto).upper(),
                                        'direccionProyecto': str(direccionProyecto).upper(),
                                        'barrioProyecto': str(barrioProyecto).upper(),
                                        'nombreCiudadoMunicipio': str(nombreCiudadoMunicipio).upper(),
                                        'nombreDepartamento': str(nombreDepartamento).upper(),
                                        'dia': str(dia).upper(),
                                        'mes': str(mes).upper(),
                                        'anio': str(anio).upper(),
                                        ...
                                        'LN_CORR_MIN_PR': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[6]].iloc[0], 2),
                                        'LN_CORR_MED_PR': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[8]].iloc[0], 2),
                                        'LN_CORR_MAX_PR': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[7]].iloc[0], 2),
                                        ...
                                        'LN_CORR_MIN_MX': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[6]].iloc[3], 2),
                                        'LN_CORR_MED_MX': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[8]].iloc[3], 2),
                                        'LN_CORR_MAX_MX': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[7]].iloc[3], 2),
                                        ...
                                        'LN_CORR_MIN_PM': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[6]].iloc[1], 2),
                                        'LN_CORR_MED_PM': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[8]].iloc[1], 2),
                                        'LN_CORR_MAX_PM': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[7]].iloc[1], 2),
                            ...
                            if latitud and longitud:
                                try:
                                    ...
                                    registro = {
                                        ...
                                        #'L3_CORR_MED_MN': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[8]].iloc[2], 2),
                                        #'L3_CORR_MAX_MN': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[7]].iloc[2], 2),
                                        'LN_CORR_MIN_MN': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[6]].iloc[2], 2),
                                        'LN_CORR_MED_MN': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[8]].iloc[2], 2),
                                        'LN_CORR_MAX_MN': round(df_Tabla_Calculos_Corriente[listado_Registro_Corriente[7]].iloc[2], 2),
